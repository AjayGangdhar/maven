...
public class Assignment10_SortingNumbersWithTemp {
    ...
    public static void main(String args[]) {
		...
		List<Integer> num = List.of(12, 34, 11, 36, 87, 98, 93);
		List<Integer> sorted = num.stream().sorted(Comparator.reverseOrder()).collect(Collectors.toList());
		System.out.println("Second largest "+ sorted.get(1));
		System.out.println("Thirs largest "+ sorted.get(2));
    }
}